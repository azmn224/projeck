...
if (isset($_POST['simpan'])) { //untuk create
  ...
  if ($nama_pembeli && $alamat_pembeli && $merek_barang) {
    if ($op == 'edit') { //untuk update
      $sql1 = "update data_user set nama_pembeli = '$nama_pembeli', alamat_pembeli = '$alamat_pembeli', merek_barang = '$merek_barang', where id_pembeli = '$id_pembeli'";
      $q1 = mysqli_query($koneksi, $sql1);
      if ($q1) {
      ...
      $sql1 = "insert into pembeli(nama_pembeli,alamat_pembeli,merek_barang,stok_barang,harga_barang) values ('$nama_pembeli','$alamat_pembeli','$merek_barang','$harga_barang)";
      $q1 = mysqli_query($koneksi, $sql1);
      if ($q1) {
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="" method="POST">
          ...
          <div class="mb-3 row">
            <label for="merek_barang" class="col-sm-2 col-form-label">merek_barang</label>
            <div class="col-sm-10">
              <select class="form-control" name="merek_barang" id="merek_barang">
                <option value="">- pilih merek_barang -</option>
                <option value="burberry" <?php if ($merek_barang == "Celana Nudie Jeans")
                  echo "selected" ?>>Celana Nudie Jeans</option>
                  <option value="adidas" <?php if ($merek_barang == "Celana Jeans Levis")
                  echo "selected" ?>>Celana Jeans Levis</option>
                  <option value="gap" <?php if ($merek_barang == "Jaket Gelembung")
                  echo "selected" ?>>Jaket Gelembung</option>
                  <option value="dickies" <?php if ($merek_barang == "Dior")
                  echo "selected" ?>>Dior</option>
                  <option value="stussy" <?php if ($merek_barang == "Hermes")
                  echo "selected" ?>>Hermes</option>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <table class="table">
            ...
            <tbody>
              <?php
                $sql2 = "select * from pembeli order by id_pembeli";
